...
-- 
-- ontology 
ALTER TABLE ontology_term ADD CONSTRAINT FKontology_ontology FOREIGN KEY ( ontology_id ) REFERENCES ontology ( ontology_id ) ON DELETE CASCADE ; 
-- ontology_dbxref 
