...
CREATE TABLE reference ( 
	 ...
	 reference_medline int NOT NULL ); 
...
CREATE TABLE seqfeature_qualifier ( 
	 seqfeature_qualifier_id serial , 
...
CREATE TABLE seqfeature_key ( 
	 seqfeature_key_id serial , 
	 key_name varchar ( 255 ) NOT NULL ); 

CREATE TABLE seqfeature_source ( 
	 seqfeature_source_id serial , 
	 source_name varchar ( 255 ) NOT NULL ); 

CREATE TABLE seqfeature ( 
	 seqfeature_id serial , 
	 bioentry_id int NOT NULL , 
