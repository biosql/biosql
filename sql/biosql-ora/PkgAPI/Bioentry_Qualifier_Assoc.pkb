...
--
-- $Id: Bioentry_Qualifier_Assoc.pkb,v 1.1.1.2 2003-01-29 08:54:37 lapp Exp $
--
...
FUNCTION get_oid(
		...
		Ont_Cat_NAME	IN SG_ONTOLOGY_TERM.NAME%TYPE DEFAULT NULL,
		Ont_Cat_Cat_OID	IN SG_ONTOLOGY_TERM.ONT_OID%TYPE DEFAULT NULL,
		Ont_Cat_IDENTIFIER	IN SG_ONTOLOGY_TERM.IDENTIFIER%TYPE DEFAULT NULL,
...
BEGIN
	...
	IF (ONT_OID_ IS NULL) THEN
		ONT_OID_ := Ont.get_oid(
				...
				Cat_Name => Ont_Cat_Name,
				Cat_Identifier => Ont_Cat_Identifier,
				Cat_Cat_Oid => Ont_Cat_Cat_Oid);
	END IF;
	-- look up SG_BIOENTRY
	...
	END IF;
	-- we only insert here - there's no UK
