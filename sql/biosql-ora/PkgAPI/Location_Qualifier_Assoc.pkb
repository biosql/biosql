...
--
-- $Id: Location_Qualifier_Assoc.pkb,v 1.1.1.1 2002-08-13 19:51:10 lapp Exp $
--
...
BEGIN
	...
	END IF;
	-- look up
	FOR LocOntA_row IN LocOntA_c (LOC_OID_, ONT_OID_) LOOP
	        pk := 1;
	END LOOP;
...
PROCEDURE do_update(
		LocOntA_LOC_OID	IN SG_LOCATION_QUALIFIER_ASSOC.LOC_OID%TYPE,
		LocOntA_ONT_OID	IN SG_LOCATION_QUALIFIER_ASSOC.ONT_OID%TYPE,
		LocOntA_VALUE	IN SG_LOCATION_QUALIFIER_ASSOC.VALUE%TYPE)
IS
BEGIN
	-- update the record (and leave attributes passed as NULL untouched)
	UPDATE SG_LOCATION_QUALIFIER_ASSOC
	SET
		VALUE = NVL(LocOntA_VALUE, VALUE)
	WHERE LOC_OID = LocOntA_LOC_OID AND ONT_OID = LocOntA_ONT_OID
	;
END;
