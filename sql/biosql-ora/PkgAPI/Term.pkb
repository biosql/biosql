...
--
-- $GNF: projects/gi/symgene/src/DB/PkgAPI/Term.pkb,v 1.5 2003/05/23 17:42:28 hlapp Exp $
--
...
IS
	...
	key_str	VARCHAR2(128) DEFAULT Trm_NAME || '|' || ONT_OID || '|' || ONT_NAME || '|' || Trm_IDENTIFIER;
BEGIN
	-- initialize
