...
ALTER TABLE dbxref CHANGE COLUMN accession accession VARCHAR(128) binary NOT NULL;

-- correspondingly, do the same for bioentry.accession
ALTER TABLE bioentry CHANGE COLUMN accession accession VARCHAR(128) binary NOT NULL;
